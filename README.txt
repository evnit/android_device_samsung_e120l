for AOKP:
1/ Creat e120l.mk in: vendor/aokp/products/

# Inherit AOSP device configuration for e120l.
...
# e120l overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/aokp/overlay/e120l

# Setup device specific product configuration.
PRODUCT_DEVICE := e120l
PRODUCT_NAME := aokp_e120l
...
# Copy e120l specific prebuilt files
PRODUCT_PACKAGES += \
    Thinkfree
...
2/ Copy, paste, rename /vendor/aokp/overlay/samsung/i9100 to e120l and modify you want
...
remove config_enableTorch in /device/samsung/e120l/overlay/frameworks/base/core/res/res/values/config.xml
